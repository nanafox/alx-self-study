...
/* Algorithm
    ...
    3.1 Per the requirements, it's actually just testing for equality.
        I believe the requirement just contains fluff about it being greater than "x" and less than "y"
    4. print description based on requirements.

    Side note:
        Had thoughts on using the switch()... case:... for flow control. Here's why
        I didn't use it.

        1. I just wanted didn't to write more lines of code.
        2. It makes it easier to improve the code later when requirement change and an actual range is required.
            - That way, you just modify the logic of your conditional statements
